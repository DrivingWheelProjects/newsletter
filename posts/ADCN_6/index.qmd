---
title: "ADCN: Biomarkers, Player Tracking Viz, Womens Update"
author: "Brad Stenger"
date: "2025-12-17"
---
...
Could something like Biolyz work for high stakes professional and college sports leagues in the U.S.? The compact geography of Europe works in favor of Biolyz' rapid processing. The company's academic roots also set Biolyz up to translate and commercialize what had been a research project. Two paths to create a similar service might work in American sports. Regional sports mass spec labs could spin up in places with large enough athlete and technician populations, helped by investment from deep-pocketed sports team(s) who want the competitive advantage. Alternatively, global mass spec manufacturers like Thermo Rest or Agilent might look to sports as a way to increase their public profile with the attention that partnership with a sports league offers. For comparison, sample testing on drawn blood in the U.S. takes 7-14 days and returns 50-70 biomarkers. Blood test cost hundreds of dollars despite (or maybe because of) the nationwide network of medical and lab infrastructure that supports blood testing. 
...
Jason Heikenfeld, an engineer at the University of Cincinnati, is the inventor of the sweat biomarker detector that eventually became Gatorade's [sweat patch](https://www.gatorade.com/resources/how-wearables-sweat-testing-are-changing-sports). [He thinks](https://www.uc.edu/news/articles/2025/01/breakthrough-wearable-lets-you-tune-in-to-heart-health.html) that interstitial fluid is capable of more robust biochemical analysis and has founded a company, Kilele Health, to develop the technology. University of Pittsburgh researchers [have created tests](https://www.futurity.org/antibody-test-3306782/?utm_source=rss&utm_medium=rss&utm_campaign=antibody-test-3306782) for interstitial fluid that detect drugs (marijuana, fentanyl) and, in other circumstances, antibodies responding to infections (like COVID). These are specific electro-chemical tests that work like CGMs. Heikenfeld's [new startup](https://www.kilelehealth.com/) plans to develop new classes of bioaffinity sensors based on CRISPR-type enzymes for gene sequence recognition, though it will take work to extend the longevity and stability of these chemical processes in order to incorporate the new technology into a wearable.

What is becoming increasingly apparent is that concurrent biometric, activity and biomarker data add to a sum that is greater its parts. The [latest](https://www.nature.com/articles/s41746-025-01466-9) Epicore sweat sensor combines electro-chemical sodium detection with skin temperature sensors and an accelerometer to measure activity-level. Borussia Dortmund uses the Biolyz biomarker panel alongside player-tracking and athlete health-performance data. Whoop, makers of a consumer biometric-sensing band, introduced a biomarker lab service to complement the algorithmic recommendations based on wearables data. Orreco, a rapid blood biomarker service for professional teams based in Ireland, [will be integrating](https://www.sharktankblog.com/mark-cuban-backs-orreco-4m-acquisition/) its data with motion-tracking data sources from Sportradar and Data Driven Sports Analytics, an Australian computer vision company.
...
The opposite extreme is to display each data point and see the patterns that emerge in high-density data visualization for player tracking data. For example, this is what one weekend of NFL games worth of pass receiver tracking looks like (from [2026 Big Data Bowl data](https://www.kaggle.com/competitions/nfl-big-data-bowl-2026-analytics/data)).

[![https://observablehq.com/d/ceef7c78a05a8380](chart2.png)]{width=720}
