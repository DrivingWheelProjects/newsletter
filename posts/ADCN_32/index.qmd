...
The translator in the T-A-T role helps with the challenge of translational research, taking the research that originates in an experiment or a question and then delivering on its practical benefit and the solution it offers to real-world problems. Hands-on abilities as technician and analyst are invaluable here, but the job also requires curiosity, intelligence, the patience to listen, and the ability to communicate. Also, be friendly. Translating research is like sales. It gets a lot easier when people like you.
