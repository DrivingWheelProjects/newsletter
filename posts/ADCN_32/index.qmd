---
title: "ADCN: Technician-Analyst-Translator, Good Bad Knees, News"
author: "Brad Stenger"
date: "2026-07-12"
---
...
The translator part of a T-A-T role helps with the challenge of translational research, taking the research that originates in an experiment or a question and then delivering on its practical benefit and the solution it offers to real-world problems. Hands-on abilities as technician and analyst are invaluable here, but the job also requires curiosity, intelligence, the patience to listen, and the ability to communicate. Also, be friendly. Translating research is like sales. It gets a lot easier when people like you.
...
I recently visited Natalie Kupperman at the University of Virginia. She has a PhD in Physical Therapy and has been an athletic trainer in the UVA athletic department, where she carried out a number of significant field studies. As the university moved to create a School of Data Science, one objective has been to have the school work closely with university athletics, giving Kupperman an academic homebase. Kupperman has one foot in the university research operation and one foot in the university athletic community, effectively cementing the two. It's been a fruitful collaboration that is poised to grow.
...
Baseball, both college and professional, might be the best proof that research pays off. The Wake Forest Pitching Laboratory has [developed](https://www.sloansportsconference.com/event/leveraging-data-for-athlete-health-and-performance) elite pitching prospects and made a consistent ACC (but not College World Series) winner. Major League Baseball teams have borrowed (and hired and drafted) regularly from leading baseball lab consultancies, Driveline and Tread. The understanding of the links between biomechanics and player performance has improved enormously as more information comes out of the research, with lots more runway for further innovation.
